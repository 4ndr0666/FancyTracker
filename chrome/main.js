...
(function() {
    ...
    function isFromIgnoredExtension(data) {
        ...
        // Every extension uses different patterns...
        if (typeof data === 'object' && data !== null) {
            // Method 1: Check 'ext' field
            ...
            // Method 3: Check common sender/source field values
    ...
    var m = function(detail) {
        // High-fidelity snatching trigger
        var raw = JSON.stringify(detail.data || "");
        if (raw.includes('.mp4')) {
            console.log("%cΨ-SIGNAL_SNATCHED: " + h(detail.source), "color:#00E5FF; font-weight:bold; background:#000; padding:2px;");
        }
        window.postMessage({
